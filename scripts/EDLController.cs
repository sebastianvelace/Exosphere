...
public partial class EDLController : Control
{
    ...
    private const double FinalDualEngineDescentBiasGain = 3.0;
    private const double FinalDualEngineDescentBiasLimitMps2 = 18.0;
        ...
        if (_phase is Edl.Retro or Edl.Catch or Edl.Final)
        {
            ...
            double descentBias = System.Math.Clamp(
                _phase == Edl.Final && _landingEngineCount == 1
                    ...
                    : _phase == Edl.Final && _landingEngineCount >= MinimumFinalApproachEngines
                        ? FinalDualEngineDescentBiasGain * verticalError
                        : 0.90 * verticalError,
