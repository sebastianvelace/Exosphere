...
has 'source=NAIP+3DEP' "$controller" "regional terrain source is not visible in runtime diagnostics"
has 'starbase_naip_10km_mask.png' "$controller" "NAIP no-data mask is not bound"
has 'starbase_3dep_10km_height.png' "$controller" "3DEP height asset is not bound"
...
has 'starbase_naip_50km_mask.png' "$controller" "macro NAIP no-data mask is not bound"
has 'starbase_3dep_50km_height.png' "$controller" "macro 3DEP height asset is not bound"
