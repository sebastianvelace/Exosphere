...
has 'textureLod(regional_height_tex, regional, 0.0)' "$shader" "regional terrain relief is not sampled in the vertex path"
...
has 'textureLod(macro_height_tex, macro, 0.0)' "$shader" "macro terrain relief is not sampled in the vertex path"
