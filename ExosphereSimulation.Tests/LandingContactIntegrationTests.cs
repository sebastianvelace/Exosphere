...
public sealed class LandingContactIntegrationTests
{
    ...
    public void EdlFinalApproachHasGatedSingleEngineLowEnergyState()
    {
        ...
        Assert.Contains("&& _landingEngineCount >= MinimumFinalApproachEngines", source);
        ...
        Assert.Contains("FinalDualEngineDescentBiasGain = 1.5", source);
        Assert.Contains("FinalDualEngineDescentBiasLimitMps2 = 12.0", source);
