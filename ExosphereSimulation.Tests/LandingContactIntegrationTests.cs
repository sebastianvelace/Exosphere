...
public sealed class LandingContactIntegrationTests
{
    ...
    public void EdlFinalApproachHasGatedSingleEngineLowEnergyState()
    {
        ...
        Assert.Contains("FinalDualEngineLockAltitudeM = 50.0", source);
        Assert.Contains("&& _alt > FinalDualEngineLockAltitudeM", source);
        ...
        Assert.Contains("FinalDualEngineDescentBiasLimitMps2 = 9.5", source);
